            ...
            {listCart &&
              listCart.map((value) => (
                <tr className="text-center" key={value._id}>
                  ...
                  <td className="align-middle border-0">
                    <p className="mb-0 small">{value.delivery ? "Waiting for progressing" : value.status}</p>
                  </td>
                  <td className="align-middle border-0">
                    <p className="mb-0 small">{!value.status ? "Waiting for pay" : value.status}</p>
                  </td>
                  <td className="align-middle border-0">
